...
/**
 * Idempotent: returns the existing active owner→CFO root delegation if one
 * exists, otherwise creates and signs a new one. Prevents duplicate roots when
 * the owner grants via the UI and then runs the month.
 */
